...
class TaskDaoTestSuite {
    ...
    private static final String DESCRIPTION = "Test: Learn Hiberate";
    @Test
    ...
    void testNamedQueries(){
        ...
        TaskList taskList = new TaskList("TODO taskList");
        ...
        List<Task> durationLongerThenTask = taskDao.retrieveTest1(6);
